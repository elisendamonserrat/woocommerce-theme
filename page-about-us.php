...
<main class="content container">
  ...
  <section> 
    <h2>La fabrica</h2>
    <p>Situados cerca de Barcelona en Llissá De Vall, disponemos de un parque de maquinaria, compuesto por telares Dornier neumáticos y de pinza, equipados con Jacquard y maquineta de lizos.</p>
    <p>Además en nuestras instalaciones hay dos urdidores seccionales, bobinadoras, máquinas de inspección y otros complementos auxiliares.</p>
    ...
    <p>Tenemos una estructura humana dinámica, la empresa produce tejidos para sus propias colecciones y una gran parte para especificaciones de sus clientes.</p>
    <p>Para poder satisfacer estas necesidades en nuestras instalaciones, disponemos de un almacén de materias primas 150 referencias de hilatura con su colorido y producto acabado, y también para servicio metraje.</p>
  </section>
  <section> 
