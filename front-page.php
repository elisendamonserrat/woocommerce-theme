    ...
    <div class="categories-list">
      <div class="category__div"> 
        <div class="category__div__img">
          <img src="<?php bloginfo('template_directory');?>/images/upholstery.jpg">
      ...
      <div class="category__div">
        <div class="category__div__img">
          <img src="<?php bloginfo('template_directory');?>/images/contract.jpg">
          <div class="category__div__img--link">
            <a href="#">Ver productos</a>
          </div>
        </div>
      ...
      <div class="category__div">
        <div class="category__div__img">
          <img src="<?php bloginfo('template_directory');?>/images/vynil-rug.jpg">
          <div class="category__div__img--link">
            <a href="#">Ver productos</a>
          </div>
        </div>
